            ...
            <div class="row g-4">
                    ...
                    <div class="sticky-top" style="top: 20px;">
                        ...
                        <div class="mt-4 p-2">
                            ...
                            <select class="form-select border-0 shadow-sm rounded-3 py-2"
                                ...
                                <option value="{{ route('admin.analysis.restaurant') }}"
                                    {{ is_null($restaurantId) ? 'selected' : '' }}>All Restaurants</option>
                ...
                <div class="col-lg-10">
                    ...
                    <div class="text-center m-5">
                        <button class="btn btn-outline-warning rounded-pill px-5 shadow-sm fw-bold border-2" type="button"
                            data-bs-toggle="collapse" data-bs-target="#yearlyReport">
                                        ...
                                        @foreach (['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'] as $i => $monthName)
                                            <tr class="{{ now()->month - 1 == $i ? 'table-warning' : '' }}">
                                                ...
                                                <td class="text-end pe-4 fw-bold">
                                                    {{ number_format($monthlyAvgStay[$i] ?? 0, 1) }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="analysis-card shadow-sm h-100">
                                <h6 class="chart-title"><i class="fa-solid fa-clock me-2 text-warning"></i>Peak Hours
                                    (Arrivals)</h6>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="analysis-card shadow-sm">
                                <h6 class="chart-title">
                                    <i class="fa-solid fa-calendar-day me-2 text-warning"></i>Daily Reservation Count
                                    ({{ now()->format('F Y') }})
                                </h6>
                        ...
                        <div class="col-md-5">
                            <div class="analysis-card shadow-sm h-100">
                                <h6 class="chart-title"><i class="fa-solid fa-chart-line me-2 text-warning"></i>Monthly
                                    Booking Trend</h6>
