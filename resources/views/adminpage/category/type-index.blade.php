...
@section('title', 'Admin Category | Type')
    ...
    <div class="row justify-content-center mt-4">
        ...
        <div class="col-9">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h2 class="h4 mb-0 text-secondary">Type Management</h2>
                ...
                <tbody class="text-center">
                    @forelse ($all_types as $type)
                        <tr>
                            ...
                            <td>{{ optional($type->updated_at)->format('Y-m-d H:i') }}</td>
                            <td>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center py-4 text-muted">No types found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
