            ...
            <div class="col-md-10">
                ...
                <div class="analysis-container shadow-sm border-0 rounded-4">
                    <h4 class="fw-bold mb-4">
                        <i class="fa-regular fa-calendar-check me-2"></i>Summary of {{ now()->format('F') }}
                    </h4>
                    <div class="d-flex justify-content-center gap-4 flex-wrap">

                        <div class="kpi-box border-0 shadow-sm" style="background: #f8f9fa;">
                            <div class="text-muted small fw-bold text-uppercase ls-1">Total Customers</div>
                        ...
                        <div class="kpi-box border-0 shadow-sm" style="background: #f8f9fa;">
                            ...
                            <div class="text-muted small mt-2">
                                Avg. ${{ $kpi->customers > 0 ? number_format($kpi->sales / $kpi->customers) : 0 }} / guest
                            </div>
                        </div>
                ...
                <div class="analysis-container shadow-sm border-0 rounded-4">
                    <div class="row">
                        <div class="col-md-8 mx-auto">
                            <h6 class="text-center fw-bold mb-3">Monthly Hotel Bookings</h6>
