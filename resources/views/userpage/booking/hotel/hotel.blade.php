...
@push('styles')
    ...
    <style>
        ...
        .hover-move:active { transform: scale(0.97); }
        .btn-hover-move {
        ...
        .btn-hover-move:active { transform: scale(0.95); }
    </style>
@endpush
            ...
            <div class="col-lg-10 text-center">
                ...
                <div class="hotel-gallery mb-5 animate-fade-in delay-1">
                    ...
                    @else
                        <img src="{{ $hotel->image_path ?? asset('images/default-hotel.jpg') }}"
                            class="img-fluid rounded-4 shadow-sm w-100 hover-move"
                ...
                <div class="row g-4 justify-content-center animate-fade-in delay-2">
                    @foreach ($hotel->roomTypes as $roomType)
                        @if (!request('room_type_id') || request('room_type_id') == $roomType->type_id)
                        <div class="col-md-10 col-lg-8">
                            <div class="res-card text-start shadow-sm hover-move">

                                <div class="d-md-flex justify-content-between align-items-center mb-4">
                                    <h3 class="fw-bold mb-0">
                                        {{ ucfirst($roomType->roomType->name) }}
                                    </h3>
                                ...
                                <form method="GET" action="{{ route('user.mypage.show') }}">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 mt-4">
                                            <button type="submit"
                                                class="btn btn-primary btn-round w-100 py-3 shadow btn-hover-move">
