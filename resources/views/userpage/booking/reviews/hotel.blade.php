...
@section('content')
    ...
    <div class="container py-5">
        ...
        <div class="review-header d-flex align-items-center justify-content-between shadow-sm"
            style="background: white; border-radius: 20px; padding: 40px; margin-bottom: 40px; border: 1px solid #f1f5f9;">

            <div class="flex-grow-1 me-4" style="min-width: 0;">
                <span class="badge bg-soft-primary text-primary mb-3 rounded-pill px-3 py-2 fw-bold"
                    style="background: #eef2ff;">
                    <i class="fa-solid fa-tag me-1"></i> {{ ucfirst($type) }}
                </span>

                <h1 class="fw-bold mb-2 text-dark"
                    style="font-size: 2.5rem; overflow-wrap: break-word; word-break: break-word;">
                    {{ $target->name }}
                </h1>

                <p class="text-muted mb-0 fs-5 text-truncate"> 
                    <i class="fa-solid fa-location-dot me-2 text-danger"></i>{{ $target->address }}
                </p>
            </div>

            <div class="text-center p-4 rounded-4 flex-shrink-0"
                style="background: #f8fafc; width: 200px; border: 1px solid #e2e8f0;">
                <div class="rating-big-number mb-2"
                    style="font-size: 3.5rem; font-weight: 800; color: #1e293b; line-height: 1;">
                    {{ number_format($target->star_rating, 1) }}
                </div>
                <div class="star-filled mb-2" style="color: #ffc107;">
                    @php
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <div class="text-muted small">
                                        <i
                                            class="fa-regular fa-calendar-check me-1"></i>{{ $review->created_at->format('M d, Y') }}
                                    </div>
                                </div>
                            </div>
