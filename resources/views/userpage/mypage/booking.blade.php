    ...
    <div class="mypage-wrapper">
        ...
        ════════════════════════ --}}
            <div class="bk-tab-pane active" id="tab-hotel">
                    ...
                    <div class="bk-card">
                        <div class="bk-card-body">
                            ...
                            <div class="bk-card-info">
                                ...
                                <div class="bk-card-meta">
                                    <span><i class="fa-regular fa-calendar"></i>
                                        {{ \Carbon\Carbon::parse($res->start_at)->format('M d, Y') }}</span>
                                    <span><i class="fa-solid fa-arrow-right"></i>
                                        {{ \Carbon\Carbon::parse($res->end_at)->format('M d, Y') }}</span>
                            ...
                            <div class="bk-card-right">
                                ...
                                <span class="bk-badge active"><i class="fa-solid fa-circle" style="font-size:6px;"></i>
                                    Active</span>
                                {{-- ▼▼▼ キャンセルボタン ▼▼▼ --}}
                                <button class="bk-cancel-btn" data-bs-toggle="modal"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content" style="border-radius:16px; overflow:hidden;">
                                <div class="modal-header" style="background:#c62828; color:#fff; border:none;">
                                    <h5 class="modal-title"><i class="fa-regular fa-triangle-exclamation me-2"></i>Cancel
                                        Reservation</h5>
                                    <button type="button" class="btn-close btn-close-white"
                                        data-bs-dismiss="modal"></button>
                                </div>
                                <div class="modal-body" style="padding:1.5rem;">
                                    <p class="mb-3" style="color:#555;">Are you sure you want to cancel this reservation?
                                    </p>
                                ...
                                <div class="modal-footer" style="border:none; padding:1rem 1.5rem;">
                                    ...
                                    <form action="{{ route('user.reservation.cancel', $res->reservation_id) }}"
                                        method="POST">
                                        @csrf
                ...
                @empty
                    <div class="bk-empty"><i class="fa-regular fa-calendar-xmark"></i>No upcoming hotel reservations.
                    </div>
                @endforelse
                ...
                @forelse($pastHotels as $res)
                    @php $review = $res->review ?? null; @endphp
                    <div class="bk-card">
                        <div class="bk-card-body">
                ...
                @forelse($cancelledHotels as $res)
                    <div class="bk-card">
                        <div class="bk-card-body">
                            ...
                            <div class="bk-card-right">
                                <div class="bk-price">₱{{ number_format($res->total_price, 2) }}</div>
                                <span class="bk-badge cancelled"><i class="fa-solid fa-xmark" style="font-size:9px;"></i>
                                    Cancelled</span>
                            </div>
                        </div>
                    </div>
                @empty
                    <div class="bk-empty"><i class="fa-regular fa-calendar-xmark"></i>No cancelled hotel reservations.
                    </div>
                @endforelse
        ...
        ════════════════════════ --}}
            <div class="bk-tab-pane" id="tab-restaurant">
                ...
                @forelse($upcomingRestaurants as $res)
                    <div class="bk-card">
                        <div class="bk-card-body">
                            ...
                            <div class="bk-card-info">
                                ...
                                <div class="bk-card-meta">
                                    <span><i class="fa-regular fa-calendar"></i>
                                        {{ \Carbon\Carbon::parse($res->start_at)->format('M d, Y H:i') }}</span>
                                    <span><i class="fa-regular fa-user"></i> {{ $res->guests }} guests</span>
                                </div>
                                <div class="bk-res-id mt-1"># {{ $res->reservation_id }}</div>
                            </div>
                            <div class="bk-card-right">
                                ...
                                <span class="bk-badge active"><i class="fa-solid fa-circle" style="font-size:6px;"></i>
                                    Active</span>
                                <button class="bk-cancel-btn" data-bs-toggle="modal"
                                    data-bs-target="#cancelModalRest{{ $res->reservation_id }}">
                                    <i class="fa-solid fa-xmark"></i> Cancel
                                </button>
                            </div>
                        </div>
                    ...
                    {{-- ▼▼▼ レストランキャンセル確認モーダル ▼▼▼ --}}
                    <div class="modal fade" id="cancelModalRest{{ $res->reservation_id }}" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content" style="border-radius:16px; overflow:hidden;">
                                <div class="modal-header" style="background:#c62828; color:#fff; border:none;">
                                ...
                                <div class="modal-body" style="padding:1.5rem;">
                                    ...
                                    <table class="table table-sm table-bordered mb-0" style="font-size:.9rem;">
                                        <tr>
                                            <th class="bg-light" style="width:40%">Restaurant</th>
                                            <td>{{ $res->restaurant->name ?? 'N/A' }}</td>
                                        </tr>
                                        <tr>
                                            <th class="bg-light">Date & Time</th>
                                            <td>{{ \Carbon\Carbon::parse($res->start_at)->format('M d, Y H:i') }}</td>
                                        </tr>
                                        <tr>
                                            <th class="bg-light">Guests</th>
                                            <td>{{ $res->guests }}</td>
                                ...
                                <div class="modal-footer" style="border:none; padding:1rem 1.5rem;">
                                    ...
                                    <form action="{{ route('user.restaurant.reservation.cancel', $res->reservation_id) }}" method="POST">
                                        @csrf
                                        <button type="submit" class="btn btn-danger btn-sm">
                                            <i class="fa-regular fa-xmark me-1"></i>Confirm Cancel
                                        </button>
                ...
                @empty
                    <div class="bk-empty"><i class="fa-regular fa-calendar-xmark"></i>No upcoming restaurant reservations.
                    </div>
                @endforelse
                ...
                @empty
                    <div class="bk-empty"><i class="fa-regular fa-calendar-xmark"></i>No cancelled restaurant
                        reservations.</div>
                @endforelse
