                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <div class="btn-group w-100" role="group" aria-label="Reservation Type">
                                <input type="radio" class="btn-check" name="reservationType" id="all"
                                    autocomplete="off" checked>
                                <label class="btn btn-outline-primary" for="all">All ✓</label>

                                <input type="radio" class="btn-check" name="reservationType" id="hotel"
                                    autocomplete="off">
                                <label class="btn btn-outline-primary" for="hotel">Hotel</label>

                                <input type="radio" class="btn-check" name="reservationType" id="restaurant"
                                    autocomplete="off">
                        ...
                        <ul class="nav nav-tabs nav-justified mb-3" id="bookingTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="cancelled-tab" data-bs-toggle="tab"
                                    ...
                                    aria-selected="false">
                                    Cancelled Reservationキャンセルした予約
                                </button>
                            </li>
                        </ul>
