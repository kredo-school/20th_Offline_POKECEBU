...
// 　ホテル・レストラン登録
// 　フォーム表示
Route::get('signup-for-company', [TmpHotelController::class, 'create'])->name('company.signup');
// 　フォーム送信
Route::post('/user/mypage/signup-for-company', [TmpHotelController::class, 'store'])->name('user.mypage.signup-for-company.store');
Auth::routes();
